            ...
            <div className="flex justify-between items-start">
                ...
                <div className="flex items-center gap-1">
                  <button 
                    ...
                    className="text-slate-500 hover:text-cyan-400 transition-colors p-1 rounded-full flex-shrink-0"
                  ...
                  <button 
                    ...
                    className="text-slate-500 hover:text-red-400 transition-colors p-1 rounded-full flex-shrink-0"
